    ...
    2: [
      function (require, module, exports) {
        ...
        const handleRating = async (e) => {
          ...
          let astonishCount = parseInt(
            buttonBar.querySelector("#click0").innerText
          );
          let heartEyeCount = parseInt(
            buttonBar.querySelector("#click1").innerText
          );
          let thumbsDownCount = parseInt(
            buttonBar.querySelector("#click2").innerText
          );
